...
/*   Updated: 2021/03/06 17:25:24 by chgilber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class	ClapTrap
{
	...
	public:
				...
				ClapTrap();
				ClapTrap(std::string name, unsigned int hp,unsigned int hpmax, unsigned int nrj, unsigned int maxnrj, unsigned int mele, unsigned int range, unsigned int armor, unsigned int lvl);
